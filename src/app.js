...
function renderApp() {
  ...
  if (["operations-advisor", "image-generate", "image-retouch", "image-outfit"].includes(state.activeMain)) {
...
const ROUTES = [
  ...
  { hash: "/image-studio", main: "image-generate" },
  { hash: "/image-studio/generate", main: "image-generate" },
