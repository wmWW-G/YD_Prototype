...
window.CUSTOMER_DEVELOPMENT = {
  ...
  leads: [
    ...
    },
    {
      ...
      size: "100-300 人",
      founded: "2016 年",
      evidence: ["展会名录显示其关注工商业储能", "官网展示 3 个在建太阳能 EPC 项目", "LinkedIn 最近招聘项目采购经理"],
    ...
    },
    {
      ...
      size: "待确认",
      founded: "2014 年",
      evidence: ["LinkedIn 多次发布储能项目交付动态", "官网案例覆盖工商业太阳能系统", "南非市场近期停电压力带来储能需求"],
    ...
    },
    {
      ...
      size: "20-60 人",
      founded: "2019 年",
      evidence: ["官网展示光伏组件和配件", "未看到储能重点页面", "可从 LinkedIn 继续补联系人"],
    ...
    },
    {
      ...
      size: "30-90 人",
      founded: "2015 年",
      evidence: ["LinkedIn 发布绿色建筑和能源项目", "官网未明确采购储能产品", "适合先用案例试探需求"],
    ...
    },
    {
      ...
      size: "15-50 人",
      founded: "2020 年",
      evidence: ["展会名录有光伏配件标签", "官网产品线偏配件", "储能是否匹配需首轮验证"],
    ...
    },
    {
      ...
      size: "10-30 人",
      founded: "2017 年",
      evidence: ["官网偏零售终端", "未看到批量采购或项目交付信息", "可能不适合作为优先开发对象"],
    ...
    },
    {
      ...
      size: "20-50 人",
      founded: "2010 年",
      evidence: ["主营电工耗材", "未看到太阳能或储能类目", "优先级低"],
    ...
    },
    {
      ...
      size: "10-20 人",
      founded: "2021 年",
      evidence: ["主营家居装饰", "未发现能源产品", "建议从获客列表剔除"],
