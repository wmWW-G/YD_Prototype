...
window.NAV_GROUPS = [
  ...
  { id: "operations-advisor", label: "ALI运营顾问", icon: "assets/icons/03_market_research.svg", type: "single" },
  {
    ...
    type: "group",
    children: [
      { id: "image-main", label: "主图", icon: "assets/icons/16_yd_artifact.svg" },
      { id: "image-set", label: "套图", icon: "assets/icons/16_yd_artifact.svg" },
      { id: "image-listing", label: "详情图", icon: "assets/icons/16_yd_artifact.svg" },
      { id: "image-poster", label: "海报", icon: "assets/icons/16_yd_artifact.svg" },
